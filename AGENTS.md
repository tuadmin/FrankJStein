...
This document defines the core patterns, constraints, and AI-governance rules for the FrankJStein framework (v0.6.0). **All AI agents MUST strictly adhere to these standards.**
